...
#
# Please ensure to run 'php setup/setup.php update /var/ilias/data/ilias-config.json' on each doil ILIAS instance,
...
custom_raise:
  test.fail_without_changes:
    - msg: "Missing email! Please use this command: salt 'doil.proxy' state.highstate saltenv=enable-https pillar='{\"email\": \"<your_email>\"}'"
    - failhard: True
{% endif %}